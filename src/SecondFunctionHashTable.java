...
public class SecondFunctionHashTable<E> {
	private E[] table;
	private int defaultSize = 13;
	private int currentCount = 0;
	private double load = 0.5;

	public SecondFunctionHashTable(int size)
	{
		table = (E[])new Object[nextPrime(size)];
	}
	public SecondFunctionHashTable()
	{
	...
	{
		int x = obj.hashCode() % table.length;//return value from 0 to length-1
		return 7-(x % 7);
	}
